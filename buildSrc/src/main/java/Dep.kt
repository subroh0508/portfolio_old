...
object Dep {
    ...
    const val kotlinFrontendPlugin = "org.jetbrains.kotlin:kotlin-frontend-plugin:${Versions.kotlinFrontentPlugin}"
    ...
    const val kotlinReactDom = "org.jetbrains:kotlin-react:${Versions.kotlinReact}"
